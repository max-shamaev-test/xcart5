...
',
  ...
  'file_permissions.kb_message' => 'Check our <a href="http://kb.x-cart.com/en/general_setup/installation_guide.html#permissionchecking-failed" target="_blank">Knowledge Base</a> in order to find out how to solve the problem with incorrect permissions.',
  'php_disable_functions.kb_message' => 'Check our <a href="http://kb.x-cart.com/en/general_setup/installation_guide.html#disabled-functions" target="_blank">Knowledge Base</a> in order to find out how to solve the problem with disabled PHP functions.',
  'php_pdo_mysql.kb_message' => 'Check our <a href="http://kb.x-cart.com/en/general_setup/installation_guide.html#disabled-php-extensions" target="_blank">Knowledge Base</a> in order to find out how to solve the problem with PDO extension.',
  'https_bouncer.kb_message' => 'Check our <a href="http://kb.x-cart.com/en/general_setup/installation_guide.html#https-bouncer-is-not-installed" target="_blank">Knowledge Base</a> in order to find out how to solve the problem with libCurl library.',
