...
',
  ...
  'file_permissions.kb_message' => 'Посмотрите в нашем <a href="https://kb.x-cart.com/en/general_setup/installation_guide.html#permissionchecking-failed" target="_blank">руководстве</a> как решить проблему с правами файлов.',
  'php_disable_functions.kb_message' => 'Посмотрите в нашем <a href="https://kb.x-cart.com/en/general_setup/installation_guide.html#disabled-functions" target="_blank">руководстве</a> как решить проблему с отключенными PHP функциями.',
  'php_pdo_mysql.kb_message' => 'Посмотрите в нашем <a href="https://kb.x-cart.com/en/general_setup/installation_guide.html#disabled-php-extensions" target="_blank">руководстве</a> как решить проблему с библиотекой PDO.',
  'https_bouncer.kb_message' => 'Посмотрите в нашем <a href="https://kb.x-cart.com/en/general_setup/installation_guide.html#https-bouncer-is-not-installed" target="_blank">руководстве</a> как решить проблему с библиотекой libCurl.',
  'kb_note_mysql_issue' => 'Посмотрите в нашем <a href="https://kb.x-cart.com/en/general_setup/installation_guide.html#problems-with-connection-to-database" target="_blank">руководстве</a> как решить проблему с MySQL соединением.',
  ...
  'Check for possible reasons <a href="https://kb.x-cart.com/pages/viewpage.action?pageId=7504578">here</a>.' => 'Проверьте возможные причины <a href="https://kb.x-cart.com/en/setting_up_x-cart_5_environment/setting_time_limit_of_your_server.html" target="_blank" >здесь</a>.',
