...
',
  ...
  'file_permissions.kb_message' => 'Посмотрите в нашем <a href="http://kb.x-cart.com/en/general_setup/installation_guide.html#permissionchecking-failed" target="_blank">руководстве</a> как решить проблему с правами файлов.',
  'php_disable_functions.kb_message' => 'Посмотрите в нашем <a href="http://kb.x-cart.com/en/general_setup/installation_guide.html#disabled-functions" target="_blank">руководстве</a> как решить проблему с отключенными PHP функциями.',
  'php_pdo_mysql.kb_message' => 'Посмотрите в нашем <a href="http://kb.x-cart.com/en/general_setup/installation_guide.html#disabled-php-extensions" target="_blank">руководстве</a> как решить проблему с библиотекой PDO.',
  'https_bouncer.kb_message' => 'Посмотрите в нашем <a href="http://kb.x-cart.com/en/general_setup/installation_guide.html#https-bouncer-is-not-installed" target="_blank">руководстве</a> как решить проблему с библиотекой libCurl.',
