...
!function (t, n) {
  ...
  return function (t) {
    ...
    var i = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (t) {
      ...
      var n = void 0, e = {}, r = t.attributes, o = void 0, c = void 0, u = function (t) {
    ...
    var i = document.createElement("div"), r = 0, o = function (t) {
      ...
      var n = document.createElement("script"), e = document.head;
      n.type = "text/javascript", n.src = t, e.appendChild(n), e.removeChild(n)
    }, a = function (t, n) {
      var e = encodeURIComponent("random_fun_" + ++r), i = t.replace(/callback=(\?)/, "callback=" + e);
      window[e] = n, u(i)
    }, s = function (t, n) {
      ...
      var r = Math.round(screen.width / 2 - e / 2), o = 0;
    ...
    "use strict";
    n.a = {name: "likely", prefix: "likely__"}
  }, function (t, n, e) {
    "use strict";
    var i = e(9), r = e(0), o = e(18), c = e(10), u = e(11), a = e(12), s = e(13), l = e(14), h = e(15), p = e(16),
      f = e(17), v = {
        facebook: c.a,
        gplus: u.a,
        linkedin: a.a,
    ...
    var r = e(0), o = e(19), c = e(2), u = e(1), a = e(8), s = function () {
      function t(t, n) {
      ...
      var i = n || {}, u = {counters: !0, timeout: 1e3, zeroes: !1, title: document.title, wait: 500, url: e.i(r.j)()},
        a = t[c.a.name], s = e.i(r.d)({}, u, i, e.i(r.k)(t));
      ...
      return s(t, null, [{
        ...
        key: "initiate", value: function (t, n) {
          function i() {
    ...
    var r = e(1), o = e(0), c = e(2), u = e(7), a = e(3), s = function () {
      function t(t, n) {
        for (var e = 0; e < n.length; e++) {
          var i = n[e];
          i.enumerable = i.enumerable || !1, i.configurable = !0, "value" in i && (i.writable = !0), Object.defineProperty(t, i.key, i)
    ...
    }(), l = '<span class="{className}">{content}</span>', h = function () {
      function t(n, r, c) {
      ...
      return s(t, [{
        ...
        key: "update", value: function (t) {
          var n = "." + c.a.prefix + "counter", i = e.i(r.c)(n, this.widget);
          e.i(o.e)(this.options, e.i(o.d)({forceUpdate: !1}, t)), i.forEach(function (t) {
            t.parentNode.removeChild(t)
          }), this.initCounter()
        }
      }, {
        key: "detectService", value: function () {
          var t = this.widget, n = e.i(o.f)(t).service;
        ...
        key: "detectParams", value: function () {
          var t = this.options, n = e.i(o.f)(this.widget);
          if (n.counter) {
        ...
        key: "initHtml", value: function () {
          var t = this.options, n = this.widget, i = n.innerHTML;
          n.addEventListener("click", this.click.bind(this)), n.classList.remove(this.service), n.className += " " + this.className("widget");
          var c = e.i(o.g)(l, {className: this.className("button"), content: i}),
            u = e.i(o.g)(l, {className: this.className("icon"), content: e.i(r.d)(t.svgi)});
          n.innerHTML = u + c
        }
      }, {
        ...
        key: "updateCounter", value: function (t) {
          var n = parseInt(t, 10) || 0, i = e.i(r.e)("." + c.a.name + "__counter", this.widget);
          i && i.parentNode.removeChild(i);
          var u = {className: this.className("counter"), content: n};
        ...
        key: "click", value: function () {
          ...
          if (t.click.call(this)) {
            var n = e.i(o.a)(t.popupUrl, {url: t.url, title: t.title});
        ...
        key: "addAdditionalParamsToUrl", value: function (t) {
          var n = e.i(o.h)(e.i(o.d)(this.widget.dataset, this.options.data)), i = t.indexOf("?") === -1 ? "?" : "&";
          return "" === n ? t : t + i + n
        }
      }]), t
    }();
    ...
    "use strict";
    var i = e(6), r = e(0), o = e(3), c = {};
    n.a = function (t, n, u) {
      c[t] || (c[t] = {});
      var a = c[t], s = a[n];
      if (!u.forceUpdate && s)return s;
      s = e.i(i.a)();
      var l = e.i(r.a)(u.counterUrl, {url: n});
    ...
    "use strict";
    n.a = {
      counterUrl: "https://graph.facebook.com/?id={url}&callback=?", convertNumber: function (t) {
    ...
    var i = e(0), r = e(1), o = {
      ...
      counter: function (t, n) {
        this.promises.push(n), e.i(r.b)(e.i(i.a)(t, {index: this.promises.length - 1}))
      },
      promises: [],
    ...
    "use strict";
    n.a = {popupUrl: "https://telegram.me/share/url?url={url}", popupWidth: 600, popupHeight: 500}
  }, function (t, n, e) {
    "use strict";
    n.a = {
    ...
    "use strict";
    var i = e(0), r = e(1), o = {
      counterUrl: "https://vk.com/share.php?act=count&url={url}&index={index}", counter: function (t, n) {
        this.promises.push(n), e.i(r.b)(e.i(i.a)(t, {index: this.promises.length - 1}))
    ...
    var r = e(5), o = e(2), c = e(0), u = function () {
      function t(t, n) {
        for (var e = 0; e < n.length; e++) {
          var i = n[e];
          i.enumerable = i.enumerable || !1, i.configurable = !0, "value" in i && (i.writable = !0), Object.defineProperty(t, i.key, i)
      ...
      return u(t, [{
        ...
        key: "updateCounter", value: function (t, n) {
